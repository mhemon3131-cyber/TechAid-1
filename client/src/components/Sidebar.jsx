    ...
    >
      ...
      <Box sx={{ flexGrow: 1, overflowY: 'auto', pr: 0.5, mb: 2 }}>
        ...
        <List disablePadding>
          {isCustomer ? (
            <>
              {/* --- MODULE 1: REQUESTS & AI DIAGNOSIS --- */}
              ...
              {/* --- MODULE 3: PROGRESS TRACKING & CHAT --- */}
              <Typography variant="caption" sx={{ color: '#64748B', fontWeight: 700, px: 1, mt: 1.5, mb: 0.5, display: 'block', fontSize: '0.65rem' }}>
              ...
              <ListItem disablePadding sx={{ mb: 0.5 }}>
                <ListItemButton
                  ...
                  sx={{
                    borderRadius: 2,
                    color: (activeTab === 'chat' || activeTab === 'chat-support') ? '#FFFFFF' : '#94A3B8',
                    backgroundColor: (activeTab === 'chat' || activeTab === 'chat-support') ? '#172036' : 'transparent',
                    borderLeft: (activeTab === 'chat' || activeTab === 'chat-support') ? '4px solid #00A8FF' : '4px solid transparent',
                    '&:hover': { backgroundColor: '#172036' }
                  }}
                >
                  <ListItemIcon sx={{ minWidth: 30, color: (activeTab === 'chat' || activeTab === 'chat-support') ? '#00A8FF' : '#94A3B8' }}>
                    <Mail size={16} />
                  </ListItemIcon>
            ...
            <>
              ...
              <ListItem disablePadding sx={{ mb: 1 }}>
                ...
                >
                  <ListItemIcon sx={{ minWidth: 34, color: (activeTab === 'chat' || activeTab === 'chat-support') ? '#00A8FF' : '#94A3B8' }}>
                    <Mail size={18} />
                  </ListItemIcon>
